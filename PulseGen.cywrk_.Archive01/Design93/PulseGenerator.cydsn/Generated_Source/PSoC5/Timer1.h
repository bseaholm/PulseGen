...
#define Timer1_INIT_PERIOD             197u
...
***************************************/
    ...
    ***************************************/
    ...
    #define Timer1_CONTROL             (* (reg8 *) Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define Timer1_CAPTURE_LSB         (* (reg8 *) Timer1_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Timer1_CAPTURE_LSB_PTR       ((reg8 *) Timer1_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Timer1_PERIOD_LSB          (* (reg8 *) Timer1_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Timer1_PERIOD_LSB_PTR        ((reg8 *) Timer1_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Timer1_COUNTER_LSB         (* (reg8 *) Timer1_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define Timer1_COUNTER_LSB_PTR       ((reg8 *) Timer1_TimerUDB_sT32_timerdp_u0__A0_REG )
    #elif(Timer1_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define Timer1_CAPTURE_LSB         (* (reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define Timer1_CAPTURE_LSB_PTR       ((reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define Timer1_PERIOD_LSB          (* (reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define Timer1_PERIOD_LSB_PTR        ((reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define Timer1_COUNTER_LSB         (* (reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__A0_REG )
            #define Timer1_COUNTER_LSB_PTR       ((reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Timer1_CAPTURE_LSB         (* (reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define Timer1_CAPTURE_LSB_PTR       ((reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define Timer1_PERIOD_LSB          (* (reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define Timer1_PERIOD_LSB_PTR        ((reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define Timer1_COUNTER_LSB         (* (reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
            #define Timer1_COUNTER_LSB_PTR       ((reg16 *) Timer1_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(Timer1_Resolution <= 24u)/* 24-bit Timer */
        #define Timer1_CAPTURE_LSB         (* (reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Timer1_CAPTURE_LSB_PTR       ((reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Timer1_PERIOD_LSB          (* (reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Timer1_PERIOD_LSB_PTR        ((reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Timer1_COUNTER_LSB         (* (reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define Timer1_COUNTER_LSB_PTR       ((reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define Timer1_CAPTURE_LSB         (* (reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define Timer1_CAPTURE_LSB_PTR       ((reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define Timer1_PERIOD_LSB          (* (reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define Timer1_PERIOD_LSB_PTR        ((reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define Timer1_COUNTER_LSB         (* (reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
            #define Timer1_COUNTER_LSB_PTR       ((reg32 *) Timer1_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define Timer1_COUNTER_LSB_PTR_8BIT       ((reg8 *) Timer1_TimerUDB_sT32_timerdp_u0__A0_REG )
